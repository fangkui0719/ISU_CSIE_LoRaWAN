                ...
                for num in range(0, count):
                    ...
                    for j in range(0, len(nodes)):
                        if nodes[j].bs_rx[bsid] == 1:
                            if nodes[j].sf == i + 7:
                                check_dist = nodes[j].dist[nodes[j].minBS]
                                if min_dist == 0:
                                    min_dist = check_dist
                                    min_dist_id = j
                                else:
...
# Trace File
fname = "/home/lab-3714/LoRaSim/Output/Method4/exp" + str(experiment) + "d99" + "BS" + str(nrBS) + "Intf.csv"
...
if p_value == 0.3:
    ...
    plt.legend(loc=0)
    picturename = "/home/lab-3714/LoRaSim/Output/Method4/Figure/Exp-" + str(experiment) + "-nodes-loc-" + str(time.strftime("%Y%m%d-%H%M%S", time.localtime())) + ".png"
    ...
    plt.legend(loc=0)
    picturename2 = "/home/lab-3714/LoRaSim/Output/Method4/Figure/Exp-" + str(experiment) + "-nodes-der-" + str(time.strftime("%Y%m%d-%H%M%S", time.localtime())) + ".png"
